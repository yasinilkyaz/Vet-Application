...
public class AnimalResponseWithCustomer {
    private Long id;
    private String name;
    ...
    public AnimalResponseWithCustomer() {
    }

    public AnimalResponseWithCustomer(Long id, String name, String species, String breed, Gender gender, String colour, LocalDate dateOfBirth, Customer customer) {
        this.id = id;
        this.name = name;
